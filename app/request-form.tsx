...
export default function RequestFormScreen() {
  ...
  const deliveryOptions: DeliveryOption[] = [
    {
      id: "email",
      title: "Par email",
      description: "Recevoir le relevé par email instantanément",
      icon: "mail-outline",
    ...
    },
    {
      id: "branch",
      title: "En agence",
      description: "Retirer le relevé dans une agence BNG",
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Demande envoyée",
        `Votre demande de relevé a été envoyée avec succès. Vous recevrez votre relevé ${selectedOption?.title.toLowerCase()} dans ${selectedOption?.estimatedTime.toLowerCase()}.`,
        [
          {
            text: "OK",
            onPress: () => router.back(),
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Demander un relevé</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.instructionText}>
            Sélectionnez comment vous souhaitez recevoir votre relevé de compte.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          <TouchableOpacity
            style={[styles.submitButton, (!selectedDelivery || isSubmitting) && styles.submitButtonDisabled]}
        ...
        <View style={styles.section}>
          <View style={styles.noteCard}>
            ...
            <Text style={styles.noteText}>
              Le relevé de compte contient l'historique détaillé de toutes vos transactions sur la période sélectionnée.
            </Text>
          </View>
        </View>
      </ScrollView>

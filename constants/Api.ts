...
export const API_ENDPOINTS = {
  ...
  TRANSACTION: {
    ...
    DETAILS: (tenantId: string, transactionId: string) => `/tenant/${tenantId}/transaction/${transactionId}`,
  },
  CARD: {
  ...
  RECLAMATION: {
    ...
    DETAILS: (tenantId: string, reclamationId: string) => `/tenant/${tenantId}/reclamation/${reclamationId}`,
  },
}
